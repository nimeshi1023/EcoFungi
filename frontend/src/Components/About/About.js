      ...
      <div className="bg-gradient-to-br from-green-50 via-white to-green-50 py-20 pt-32">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-6">
            ...
            <button 
              onClick={() => navigate('/login')}
              className="px-8 py-3 bg-green-600 text-white text-lg font-semibold rounded-xl hover:bg-green-700 transition-all shadow-md"
            >
              Get Started →
            </button>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {[
              ...
              <div
                key={index}
                className="bg-white rounded-2xl shadow-md p-8 text-center transition-all transform hover:scale-105"
              >
